...
const Hero = () => {
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            >
              ...
              <p className="text-lg md:text-xl font-sans text-gray-300 mb-6 leading-relaxed">
                Full-stack developer passionate about creating beautiful and functional web applications.Exploring WEB3 and Blockchain.
              </p>
              <div className="flex items-center text-lg text-gray-400">
            <MapPin className="h-8 w-5 mr-2  text-blue-400" />
           <a href="https://www.google.com/maps/place/Karnataka/@15.0261513,73.6789652,7z/data=!3m1!4b1!4m6!3m5!1s0x3ba35a4c37bf488f:0x41f1d28cd1757c
           // d5!8m2!3d15.3172775!4d75.7138884!16zL20vMDQ5bHI?entry=ttu&g_ep=EgoyMDI1MDIxOS4xIKXMDSoASAFQAw%3D%3D" target="_blank" 
           rel="noopener noreferrer" >Karnataka, India</a>
          </div>
              <motion.div 
  ...
  rel="noopener noreferrer" 
            ...
            >
              <div className="relative w-[280px] h-[400px] sm:w-[350px] sm:h-[500px] md:w-[400px] md:h-[550px] lg:w-[450px] lg:h-[600px]">
